...
<br />
This project was copy for test and learn thanks to Robert Jordon
From: Developing Infrastructure as Code with Terraform
<br />
…or create a new repository on the command line
echo "# terraform-aws-k8s-cluster" >> README.md
git init
git add README.md
git commit -m "first commit"
git branch -M main
git remote add origin git@github.com:yanivo1/terraform-aws-k8s-cluster.git
